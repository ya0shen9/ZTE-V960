...
TARGET_BOOTLOADER_BOARD_NAME := Uv960

BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true

BOARD_KERNEL_CMDLINE := androidboot.hardware=Uv960 console=null
...
BOARD_EGL_CFG := device/zte/Uv960/prebuilt/lib/egl/egl.cfg
...
BOARD_CUSTOM_USB_CONTROLLER := ../../device/zte/Uv960/UsbController.cpp
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/zte/Uv960/recovery/recovery_ui.c

TARGET_CHINESE := true

# assert
TARGET_OTA_ASSERT_DEVICE := Uv960,v960,skate
